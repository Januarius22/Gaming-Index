...
import { submitAccountSupportTicketAction } from "@/actions/support";
    ...
    <div className="grid gap-6 xl:grid-cols-[minmax(0,0.95fr)_minmax(320px,0.55fr)]">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Send a request to Gaming Index support.</CardDescription>
        </CardHeader>
        <CardContent>
          <SupportTicketForm action={submitAccountSupportTicketAction} />
        </CardContent>
      </Card>
