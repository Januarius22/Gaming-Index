...
import { submitSellerFeedbackAction } from "@/actions/feedback";
  ...
  return (
    <div className="grid gap-6 xl:grid-cols-[minmax(0,0.95fr)_minmax(300px,0.45fr)]">
      <Card>
        ...
        <CardContent>
          <FeedbackForm action={submitSellerFeedbackAction} />
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Recent submissions from this seller workspace.</CardDescription>
        </CardHeader>
